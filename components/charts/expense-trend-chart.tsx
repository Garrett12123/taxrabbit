...
export function ExpenseTrendChart({ data, year }: Props) {
    ...
    return (
      <div className="flex h-[250px] flex-col items-center justify-center gap-4 text-center animate-slide-up">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Add expenses to see monthly trends</p>
        </div>
      </div>
    );
  }
        ...
        <AreaChart
          ...
          onClick={(state) => {
            if (state?.activePayload?.[0]) {
              ...
              router.push(`/expenses?month=${entry.monthNum}&year=${year}`);
            }
          }}
        >
          <defs>
